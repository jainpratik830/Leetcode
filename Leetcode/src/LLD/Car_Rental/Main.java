...
public class Main {
    ...
    public static void main(String[] args){
        ...
        rentalSystem.addCar(new Car("Toyota", "Camry", "2022", "ABC123", 50,CarType.SEDAN));
        rentalSystem.addCar(new Car("Honda", "Civic", "2021", "XYZ789", 45,CarType.SEDAN));
        rentalSystem.addCar(new Car("Ford", "Mustang", "2023", "DEF456", 80,CarType.SEDAN));

        // Create customers
        Customer customer1 = new Customer("John Doe",1, "john@example.com", "DL1234");
